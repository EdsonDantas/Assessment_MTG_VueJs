<template>
  <b-container style="width:100%" class="principal">
    ...
    <b-card style="max-width:95%; margin-top: 20px" :img-src="card.imageUrl" :img-alt="card.name" img-left class="mb-3">
 ...
 <!--Edição Texto original do card-->
    ...
    <!--Edição das CORES dominantes no Card-->
      ...
      <b-button class="btn-editar" type="submit" @click="fecharEditar"  variant="primary" v-show="editar">Enviar</b-button>
      </b-form>
    ...
    <b-row>
        ...
        <b-button class="btn-editar" @click="mostrarEditar"  variant="danger" v-show="!editar">Editar</b-button>
      </b-row>
  </b-container>
</template>
